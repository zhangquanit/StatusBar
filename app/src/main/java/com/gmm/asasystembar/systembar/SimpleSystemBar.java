...
public class SimpleSystemBar {
    ...
    private SimpleSystemBar(Window window, boolean lightStatusBar, boolean transparentStatusBar, boolean isSetActionbarPadding, View actionBarView, int statusBarColor) {
        this.window = window;
    ...
    private void process() {
        ...
        if (lightStatusBar) {   //白底黑色图标
            //魅族、小米
            boolean handled = processPrivateAPI();
            if (handled) return;
    ...
    public static class Builder {
        ...
        public void process() {
            ...
            new SimpleSystemBar(window, lightStatusBar, transparentStatusBar, isSetActionbarPadding, actionBarView, statusBarColor).process();
        }
    }
     ...
     * @param context
     */
    public static void setLightStatusBar(Activity context) {
        if (null == context) return;
        com.anroid.base.ui.SystemBar.clearSystemUiVisibility(context.getWindow());
        com.anroid.base.ui.SystemBar.from(context)
     ...
     *
     * @param context
     * @param topView 设置该view的paddingTop为状态栏高度
     */
    public static void setLightStatusBar(Activity context, View topView) {
        if (null == context) return;
        com.anroid.base.ui.SystemBar.clearSystemUiVisibility(context.getWindow());
        com.anroid.base.ui.SystemBar.from(context)
